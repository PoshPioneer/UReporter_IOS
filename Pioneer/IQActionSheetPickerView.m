...
//              http://stackoverflow.com/questions/5583984/objective-c-converting-date-string-into-day-of-the-week-month-name
            ...
            [dateFormatter  setDateFormat:@"yyyy-MM-dd HH:mm:ss Z"];//@"EEE, dd MMMM yyyy, HH:mm:ss Z"];// "yyyy-MM-dd HH:mm:ss Z"
