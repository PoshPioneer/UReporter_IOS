...
- (void)baseInit {
    _notSelectedStar = [UIImage imageNamed:@"Start-Empty@2x.png"];
    _selectedStar = [UIImage imageNamed:@"Star-Filled@2x.png"];
    _halfSelectedStar = [UIImage imageNamed:@"Partially-Filled@2x.png"];
